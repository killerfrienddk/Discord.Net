...
public partial interface IPartialGuildForumChannelModel : 
    IPartialModel,
    IEntityModel<ulong>,
    ...
    Discord.Models.IPartialChannelModel
{
    ...
    Discord.Optional<System.Collections.Generic.IReadOnlyCollection<Discord.Models.ITagModel>> AvailableTags { get; }

    Discord.Optional<int?> DefaultSortOrder { get; }

    Discord.Optional<int> DefaultForumLayout { get; }

    Type IPartialModel.UnderlyingModelType => typeof(Discord.Models.IGuildForumChannelModel);
}
