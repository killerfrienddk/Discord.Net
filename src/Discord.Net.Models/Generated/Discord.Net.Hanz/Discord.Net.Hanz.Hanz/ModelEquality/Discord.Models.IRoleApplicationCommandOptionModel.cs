...
public partial interface IRoleApplicationCommandOptionModel : 
    IEquatable<Discord.Models.IRoleApplicationCommandOptionModel>
{
    ...
    bool IEquatable<Discord.Models.IRoleApplicationCommandOptionModel>.Equals(Discord.Models.IRoleApplicationCommandOptionModel? other) => Equals(other);

    bool IEquatable<Discord.Models.IApplicationCommandOptionModel>.Equals(Discord.Models.IApplicationCommandOptionModel? other) => other is Discord.Models.IRoleApplicationCommandOptionModel self && Equals(self);

    bool Discord.Models.IApplicationCommandOptionModel.Equals(Discord.Models.IApplicationCommandOptionModel? other) => other is Discord.Models.IRoleApplicationCommandOptionModel self && Equals(self);
}
