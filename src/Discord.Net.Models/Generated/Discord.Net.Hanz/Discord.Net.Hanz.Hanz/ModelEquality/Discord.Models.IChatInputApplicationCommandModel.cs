...
public partial interface IChatInputApplicationCommandModel : 
    IEquatable<Discord.Models.IChatInputApplicationCommandModel>
{
    ...
    bool IEquatable<Discord.Models.IChatInputApplicationCommandModel>.Equals(Discord.Models.IChatInputApplicationCommandModel? other) => Equals(other);

    bool IEquatable<Discord.Models.IApplicationCommandModel>.Equals(Discord.Models.IApplicationCommandModel? other) => other is Discord.Models.IChatInputApplicationCommandModel self && Equals(self);

    bool Discord.Models.IApplicationCommandModel.Equals(Discord.Models.IApplicationCommandModel? other) => other is Discord.Models.IChatInputApplicationCommandModel self && Equals(self);
}
