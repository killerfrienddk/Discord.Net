...
public partial interface IMessageCreateMentionedUserModel : 
    IEquatable<Discord.Models.IMessageCreateMentionedUserModel>
{
    new bool Equals(Discord.Models.IMessageCreateMentionedUserModel? other)
    {
        if(other is null) return false;
        
        return
            EqualityComparer<IPartialMemberModel>.Default.Equals(this.Member, other.Member) &&
    ...
    bool IEquatable<Discord.Models.IMessageCreateMentionedUserModel>.Equals(Discord.Models.IMessageCreateMentionedUserModel? other) => Equals(other);

    bool IEquatable<Discord.Models.IUserModel>.Equals(Discord.Models.IUserModel? other) => other is Discord.Models.IMessageCreateMentionedUserModel self && Equals(self);

    bool Discord.Models.IUserModel.Equals(Discord.Models.IUserModel? other) => other is Discord.Models.IMessageCreateMentionedUserModel self && Equals(self);
}
