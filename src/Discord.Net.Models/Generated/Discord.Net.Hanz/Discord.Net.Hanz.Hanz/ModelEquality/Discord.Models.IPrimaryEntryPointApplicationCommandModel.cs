...
public partial interface IPrimaryEntryPointApplicationCommandModel : 
    IEquatable<Discord.Models.IPrimaryEntryPointApplicationCommandModel>
{
    new bool Equals(Discord.Models.IPrimaryEntryPointApplicationCommandModel? other)
    {
        ...
        return
            EqualityComparer<int>.Default.Equals(this.Handler, other.Handler) &&
    ...
    bool IEquatable<Discord.Models.IPrimaryEntryPointApplicationCommandModel>.Equals(Discord.Models.IPrimaryEntryPointApplicationCommandModel? other) => Equals(other);

    bool IEquatable<Discord.Models.IApplicationCommandModel>.Equals(Discord.Models.IApplicationCommandModel? other) => other is Discord.Models.IPrimaryEntryPointApplicationCommandModel self && Equals(self);

    bool Discord.Models.IApplicationCommandModel.Equals(Discord.Models.IApplicationCommandModel? other) => other is Discord.Models.IPrimaryEntryPointApplicationCommandModel self && Equals(self);
}
