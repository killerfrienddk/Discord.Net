...
public partial interface IChannelApplicationCommandOptionModel : 
    IEquatable<Discord.Models.IChannelApplicationCommandOptionModel>
{
    ...
    bool IEquatable<Discord.Models.IChannelApplicationCommandOptionModel>.Equals(Discord.Models.IChannelApplicationCommandOptionModel? other) => Equals(other);

    bool IEquatable<Discord.Models.IApplicationCommandOptionModel>.Equals(Discord.Models.IApplicationCommandOptionModel? other) => other is Discord.Models.IChannelApplicationCommandOptionModel self && Equals(self);

    bool Discord.Models.IApplicationCommandOptionModel.Equals(Discord.Models.IApplicationCommandOptionModel? other) => other is Discord.Models.IChannelApplicationCommandOptionModel self && Equals(self);
}
