...
public partial interface IGuildForumChannelModel : 
    IEquatable<Discord.Models.IGuildForumChannelModel>
{
    new bool Equals(Discord.Models.IGuildForumChannelModel? other)
    {
        ...
        return
            ...
            EqualityComparer<System.Collections.Generic.IReadOnlyCollection<Discord.Models.ITagModel>>.Default.Equals(this.AvailableTags, other.AvailableTags) &&
            EqualityComparer<int?>.Default.Equals(this.DefaultSortOrder, other.DefaultSortOrder) &&
            EqualityComparer<int>.Default.Equals(this.DefaultForumLayout, other.DefaultForumLayout) &&
    ...
    bool IEquatable<Discord.Models.IGuildForumChannelModel>.Equals(Discord.Models.IGuildForumChannelModel? other) => Equals(other);

    bool IEquatable<Discord.Models.IThreadableChannelModel>.Equals(Discord.Models.IThreadableChannelModel? other) => other is Discord.Models.IGuildForumChannelModel self && Equals(self);

    bool Discord.Models.IThreadableChannelModel.Equals(Discord.Models.IThreadableChannelModel? other) => other is Discord.Models.IGuildForumChannelModel self && Equals(self);

    bool IEquatable<Discord.Models.IGuildChannelModel>.Equals(Discord.Models.IGuildChannelModel? other) => other is Discord.Models.IGuildForumChannelModel self && Equals(self);

    bool Discord.Models.IGuildChannelModel.Equals(Discord.Models.IGuildChannelModel? other) => other is Discord.Models.IGuildForumChannelModel self && Equals(self);

    bool IEquatable<Discord.Models.IChannelModel>.Equals(Discord.Models.IChannelModel? other) => other is Discord.Models.IGuildForumChannelModel self && Equals(self);

    bool Discord.Models.IChannelModel.Equals(Discord.Models.IChannelModel? other) => other is Discord.Models.IGuildForumChannelModel self && Equals(self);
}
