...
public partial interface ISubCommandApplicationCommandOptionModel : 
    IEquatable<Discord.Models.ISubCommandApplicationCommandOptionModel>
{
    ...
    bool IEquatable<Discord.Models.ISubCommandApplicationCommandOptionModel>.Equals(Discord.Models.ISubCommandApplicationCommandOptionModel? other) => Equals(other);

    bool IEquatable<Discord.Models.IApplicationCommandOptionModel>.Equals(Discord.Models.IApplicationCommandOptionModel? other) => other is Discord.Models.ISubCommandApplicationCommandOptionModel self && Equals(self);

    bool Discord.Models.IApplicationCommandOptionModel.Equals(Discord.Models.IApplicationCommandOptionModel? other) => other is Discord.Models.ISubCommandApplicationCommandOptionModel self && Equals(self);
}
