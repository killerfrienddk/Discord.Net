...
public partial interface INumberApplicationCommandOptionModel : IEquatable<INumberApplicationCommandOptionModel>
{
    ...
    bool IEquatable<INumberApplicationCommandOptionModel>.Equals(INumberApplicationCommandOptionModel? other) => Equals(other);
    bool IEquatable<IModel>.Equals(IModel? other) => other is INumberApplicationCommandOptionModel otherThis && Equals(otherThis);
    bool IApplicationCommandOptionModel.Equals(IApplicationCommandOptionModel? other) => other is INumberApplicationCommandOptionModel otherThis && Equals(otherThis);
}