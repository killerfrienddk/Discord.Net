...
public partial interface IGuildTextChannelModel : 
    IEquatable<Discord.Models.IGuildTextChannelModel>
{
    ...
    bool IEquatable<Discord.Models.IGuildTextChannelModel>.Equals(Discord.Models.IGuildTextChannelModel? other) => Equals(other);

    bool IEquatable<Discord.Models.IThreadableChannelModel>.Equals(Discord.Models.IThreadableChannelModel? other) => other is Discord.Models.IGuildTextChannelModel self && Equals(self);

    bool Discord.Models.IThreadableChannelModel.Equals(Discord.Models.IThreadableChannelModel? other) => other is Discord.Models.IGuildTextChannelModel self && Equals(self);

    bool IEquatable<Discord.Models.IGuildChannelModel>.Equals(Discord.Models.IGuildChannelModel? other) => other is Discord.Models.IGuildTextChannelModel self && Equals(self);

    bool Discord.Models.IGuildChannelModel.Equals(Discord.Models.IGuildChannelModel? other) => other is Discord.Models.IGuildTextChannelModel self && Equals(self);

    bool IEquatable<Discord.Models.IChannelModel>.Equals(Discord.Models.IChannelModel? other) => other is Discord.Models.IGuildTextChannelModel self && Equals(self);

    bool Discord.Models.IChannelModel.Equals(Discord.Models.IChannelModel? other) => other is Discord.Models.IGuildTextChannelModel self && Equals(self);
}
