...
public partial interface IUserApplicationCommandOptionModel : 
    IEquatable<Discord.Models.IUserApplicationCommandOptionModel>
{
    ...
    bool IEquatable<Discord.Models.IUserApplicationCommandOptionModel>.Equals(Discord.Models.IUserApplicationCommandOptionModel? other) => Equals(other);

    bool IEquatable<Discord.Models.IApplicationCommandOptionModel>.Equals(Discord.Models.IApplicationCommandOptionModel? other) => other is Discord.Models.IUserApplicationCommandOptionModel self && Equals(self);

    bool Discord.Models.IApplicationCommandOptionModel.Equals(Discord.Models.IApplicationCommandOptionModel? other) => other is Discord.Models.IUserApplicationCommandOptionModel self && Equals(self);
}
