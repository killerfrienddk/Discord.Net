...
public partial interface IMentionableApplicationCommandOptionModel : 
    IEquatable<Discord.Models.IMentionableApplicationCommandOptionModel>
{
    ...
    bool IEquatable<Discord.Models.IMentionableApplicationCommandOptionModel>.Equals(Discord.Models.IMentionableApplicationCommandOptionModel? other) => Equals(other);

    bool IEquatable<Discord.Models.IApplicationCommandOptionModel>.Equals(Discord.Models.IApplicationCommandOptionModel? other) => other is Discord.Models.IMentionableApplicationCommandOptionModel self && Equals(self);

    bool Discord.Models.IApplicationCommandOptionModel.Equals(Discord.Models.IApplicationCommandOptionModel? other) => other is Discord.Models.IMentionableApplicationCommandOptionModel self && Equals(self);
}
