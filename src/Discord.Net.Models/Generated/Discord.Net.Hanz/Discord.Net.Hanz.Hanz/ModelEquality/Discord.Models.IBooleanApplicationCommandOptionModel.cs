...
public partial interface IBooleanApplicationCommandOptionModel : 
    IEquatable<Discord.Models.IBooleanApplicationCommandOptionModel>
{
    new bool Equals(Discord.Models.IBooleanApplicationCommandOptionModel? other)
    {
    ...
    bool IEquatable<Discord.Models.IBooleanApplicationCommandOptionModel>.Equals(Discord.Models.IBooleanApplicationCommandOptionModel? other) => Equals(other);

    bool IEquatable<Discord.Models.IApplicationCommandOptionModel>.Equals(Discord.Models.IApplicationCommandOptionModel? other) => other is Discord.Models.IBooleanApplicationCommandOptionModel self && Equals(self);

    bool Discord.Models.IApplicationCommandOptionModel.Equals(Discord.Models.IApplicationCommandOptionModel? other) => other is Discord.Models.IBooleanApplicationCommandOptionModel self && Equals(self);
}
