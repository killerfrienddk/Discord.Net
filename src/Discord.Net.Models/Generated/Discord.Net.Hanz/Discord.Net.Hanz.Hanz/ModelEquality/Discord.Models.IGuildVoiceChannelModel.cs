...
public partial interface IGuildVoiceChannelModel : 
    IEquatable<Discord.Models.IGuildVoiceChannelModel>
{
    ...
    bool IEquatable<Discord.Models.IGuildVoiceChannelModel>.Equals(Discord.Models.IGuildVoiceChannelModel? other) => Equals(other);

    bool IEquatable<Discord.Models.IGuildChannelModel>.Equals(Discord.Models.IGuildChannelModel? other) => other is Discord.Models.IGuildVoiceChannelModel self && Equals(self);

    bool Discord.Models.IGuildChannelModel.Equals(Discord.Models.IGuildChannelModel? other) => other is Discord.Models.IGuildVoiceChannelModel self && Equals(self);

    bool IEquatable<Discord.Models.IAudioChannelModel>.Equals(Discord.Models.IAudioChannelModel? other) => other is Discord.Models.IGuildVoiceChannelModel self && Equals(self);

    bool Discord.Models.IAudioChannelModel.Equals(Discord.Models.IAudioChannelModel? other) => other is Discord.Models.IGuildVoiceChannelModel self && Equals(self);

    bool IEquatable<Discord.Models.IChannelModel>.Equals(Discord.Models.IChannelModel? other) => other is Discord.Models.IGuildVoiceChannelModel self && Equals(self);

    bool Discord.Models.IChannelModel.Equals(Discord.Models.IChannelModel? other) => other is Discord.Models.IGuildVoiceChannelModel self && Equals(self);
}
